        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyRole = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerReferences", x => new { x.CustomerId, x.ContactPersonId });
                    table.ForeignKey(
                        name: "FK_CustomerReferences_ContactPersons_ContactPersonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Roles_CompanyRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_Services_CompanyServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerReferences_ContactPersonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_CompanyServiceId",
                table: "Projects",
